...
2. **Behavioral Drivers:** SHAP analysis revealed that recent repayment delays (`PAY_0`) serve as the primary catalyst for default predictions. Empirical data shows default rates spiking from ~15% to nearly 70% once a client reaches a two-month delinquency threshold.
